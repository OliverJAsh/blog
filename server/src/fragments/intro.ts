...
export default h('div', [
    h('p', [
        ...
        h('a', { href: 'https://www.google.co.uk/maps/place/Midhurst/@50.9817809,-0.7522787,15z/data=!3m1!4b1!4m5!3m4!1s0x4874353f6541d8ed:0xad2789872322f14d!8m2!3d50.9868979!4d-0.737274' }, 'Midhurst'),
        ', the heart of the South Downs. With an umbilical cord to London, I currently work on data visualisation tools, and previously worked on the team behind',
        ' ',
    ...
    h('p', [
        ...
        'I also',
        ' ',
        h('a', { href: 'https://samefourchords.com/', title: 'See my photography blog' }, 'love the art of photography as a tool for life documentation'),
        '.',
    ])
]);
